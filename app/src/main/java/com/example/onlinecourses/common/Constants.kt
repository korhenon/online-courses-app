...
val BaseCourse = Course(
    ...
    reviews = listOf(
        Review(
            ...
            mark = 4,
            text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non id neque sit aliquam nam molestie dignissim ac eget. Fames congue faucibus in fermentum proin. A accumsan, convallis elementum amet sed. "
        ),
        Review(
            author = "Joseph Stanly",
            date = LocalDate.of(2021, 1, 1),
